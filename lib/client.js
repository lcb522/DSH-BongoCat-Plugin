window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const CAT_SVG = (() => {
			const keys = [];
			for (let i = 0; i < 8; i++) keys.push(`<rect x="${48 + i * 15}" y="121" width="11" height="6" rx="1.5"/>`);
			for (let i = 0; i < 7; i++) keys.push(`<rect x="${55 + i * 15}" y="129" width="11" height="6" rx="1.5"/>`);
			const keyRows = keys.join("");
			return `<svg width="204" height="150" viewBox="0 0 220 160" fill="none" xmlns="http://www.w3.org/2000/svg"><ellipse cx="110" cy="152" rx="80" ry="7" fill="rgba(31,32,38,.16)"/><path d="M56 116c0-18 24-30 54-30s54 12 54 30c0 12-24 20-54 20s-54-8-54-20z" fill="#fffdf9" stroke="#3b3b46" stroke-width="2.5"/><g class="bongo-head"><path d="M70 44 60 12l38 16z" fill="#fffdf9" stroke="#3b3b46" stroke-width="2.5" stroke-linejoin="round"/><path d="M150 44l10-32-38 16z" fill="#fffdf9" stroke="#3b3b46" stroke-width="2.5" stroke-linejoin="round"/><path d="M72 38l-6-18 20 9z" fill="#f4a8bb"/><path d="M148 38l6-18-20 9z" fill="#f4a8bb"/><circle cx="110" cy="62" r="42" fill="#fffdf9" stroke="#3b3b46" stroke-width="2.5"/><path d="M84 56q5 7 10 0M126 56q5 7 10 0" stroke="#4c4c55" stroke-width="3" stroke-linecap="round"/><path d="M102 70q4 5 8 0 4 5 8 0" stroke="#4c4c55" stroke-width="3" stroke-linecap="round"/><ellipse cx="80" cy="69" rx="6" ry="3.5" fill="#f9c6d4"/><ellipse cx="140" cy="69" rx="6" ry="3.5" fill="#f9c6d4"/><path d="M50 58l16 2M52 66l15 4M170 58l-16 2M168 66l-15 4" stroke="#c9c9d2" stroke-width="2" stroke-linecap="round"/></g><g><rect x="40" y="117" width="140" height="28" rx="7" fill="#454c5f" stroke="#333947" stroke-width="2"/><g fill="#e8ebf2" opacity=".92">${keyRows}<rect x="83" y="137" width="54" height="5" rx="2"/></g></g><g class="bongo-paw" data-side="left"><ellipse cx="76" cy="96" rx="17" ry="14" fill="#fffdf9" stroke="#3b3b46" stroke-width="2.5"/><circle cx="68" cy="91" r="2.6" fill="#f4a8bb"/><circle cx="76" cy="88.5" r="2.6" fill="#f4a8bb"/><circle cx="84" cy="91" r="2.6" fill="#f4a8bb"/><ellipse cx="76" cy="99" rx="8" ry="6" fill="#f4a8bb"/></g><g class="bongo-paw" data-side="right"><ellipse cx="144" cy="96" rx="17" ry="14" fill="#fffdf9" stroke="#3b3b46" stroke-width="2.5"/><circle cx="136" cy="91" r="2.6" fill="#f4a8bb"/><circle cx="144" cy="88.5" r="2.6" fill="#f4a8bb"/><circle cx="152" cy="91" r="2.6" fill="#f4a8bb"/><ellipse cx="144" cy="99" rx="8" ry="6" fill="#f4a8bb"/></g></svg>`;
		})();
		/**
